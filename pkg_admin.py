...
parser.add_argument("-d", dest='dev', action='store_true', help="install dev branch")
parser.add_argument("-b", dest='branch', type=str, metavar=('branch_name'), help="install branch specific branch/release")
